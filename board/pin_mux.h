...
/*! @name PORTC8 (number 53), J1[7]/I2S0_MCLK
  @{ */
#define BOARD_AC_SYS_MCLK_PORT PORTC /*!<@brief PORT device name: PORTC */
#define BOARD_AC_SYS_MCLK_PIN 8U     /*!<@brief PORTC pin index: 8 */
                                     /* @} */

/*! @name PORTC5 (number 50), J1[15]/I2S0_RXD0
  @{ */
#define BOARD_AC_I2S_DOUT_PORT PORTC /*!<@brief PORT device name: PORTC */
#define BOARD_AC_I2S_DOUT_PIN 5U     /*!<@brief PORTC pin index: 5 */
                                     /* @} */

/*! @name PORTA12 (number 28), J1[5]/I2S0_TXD0
  @{ */
#define BOARD_AC_I2S_DIN_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_AC_I2S_DIN_PIN 12U    /*!<@brief PORTA pin index: 12 */
                                    /* @} */

/*! @name PORTA13 (number 29), J1[3]
  @{ */
#define BOARD_AC_I2S_LRCLK_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_AC_I2S_LRCLK_PIN 13U    /*!<@brief PORTA pin index: 13 */
                                      /* @} */
