...
/* Used DMA device. */
#define BOARD_EDMA_DMA_BASEADDR DMA0
/* Associated DMAMUX device that is used for muxing of requests. */
#define BOARD_EDMA_DMAMUX_BASEADDR DMAMUX
/* Definition of peripheral ID */
#define BOARD_SAI_AC_PERIPHERAL I2S0
...
#define BOARD_SAI_AC_TX_MCLK_SOURCE_CLOCK_HZ 120000000UL
...
#define BOARD_SAI_AC_RX_MCLK_SOURCE_CLOCK_HZ 120000000UL
/* Bit clock source frequency used for counting the bit clock divider in the Tx SetFormat type functions. */
#define BOARD_SAI_AC_TX_BCLK_SOURCE_CLOCK_HZ 11289600UL
/* Bit clock source frequency used for counting the bit clock divider in the Rx SetFormat type functions. */
#define BOARD_SAI_AC_RX_BCLK_SOURCE_CLOCK_HZ 11289600UL
/* SAI_AC eDMA source request. */
#define BOARD_SAI_AC_TX_DMA_REQUEST kDmaRequestMux0I2S0Tx
/* Selected eDMA channel number. */
#define BOARD_SAI_AC_TX_DMA_CHANNEL 0
/* DMAMUX device that is used for muxing of the request. */
#define BOARD_SAI_AC_TX_DMAMUX_BASEADDR DMAMUX
/* Used DMA device. */
#define BOARD_SAI_AC_TX_DMA_BASEADDR DMA0
/* SAI_AC eDMA source request. */
#define BOARD_SAI_AC_RX_DMA_REQUEST kDmaRequestMux0I2S0Rx
/* Selected eDMA channel number. */
#define BOARD_SAI_AC_RX_DMA_CHANNEL 1
/* DMAMUX device that is used for muxing of the request. */
#define BOARD_SAI_AC_RX_DMAMUX_BASEADDR DMAMUX
/* Used DMA device. */
#define BOARD_SAI_AC_RX_DMA_BASEADDR DMA0
/* BOARD_InitAUDIOPeripheral defines for I2C0 */
/* Definition of peripheral ID */
#define BOARD_I2C_AC_PERIPHERAL I2C0
/* Definition of the clock source */
#define BOARD_I2C_AC_CLOCK_SOURCE I2C0_CLK_SRC
/* Definition of the clock source frequency */
...
extern const edma_config_t BOARD_eDMA_config;
extern const sai_config_t BOARD_SAI_AC_tx_config;
extern sai_transfer_format_t BOARD_SAI_AC_tx_format;
extern const sai_config_t BOARD_SAI_AC_rx_config;
extern sai_transfer_format_t BOARD_SAI_AC_rx_format;
extern edma_handle_t BOARD_SAI_AC_TX_Handle;
extern edma_handle_t BOARD_SAI_AC_RX_Handle;
