...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitLSENSE
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
...
- pin_list:
  ...
  - {pin_num: '27', peripheral: I2S0, signal: TX_BCLK, pin_signal: PTA5/USB_CLKIN/FTM0_CH2/I2S0_TX_BCLK/JTAG_TRST_b}
  - {pin_num: '29', peripheral: I2S0, signal: TX_FS, pin_signal: PTA13/LLWU_P4/FTM1_CH1/I2S0_TX_FS/FTM1_QD_PHB}
...
void BOARD_InitAudioPins(void)
{
    ...
    PORT_SetPinMux(BOARD_AC_I2S_DIN_PORT, BOARD_AC_I2S_DIN_PIN, kPORT_MuxAlt6);

    /* PORTA13 (pin 29) is configured as I2S0_TX_FS */
    PORT_SetPinMux(BOARD_AC_I2S_LRCLK_PORT, BOARD_AC_I2S_LRCLK_PIN, kPORT_MuxAlt6);

    /* PORTA5 (pin 27) is configured as I2S0_TX_BCLK */
    ...
    PORT_SetPinMux(BOARD_AC_I2S_DOUT_PORT, BOARD_AC_I2S_DOUT_PIN, kPORT_MuxAlt4);

    /* PORTC8 (pin 53) is configured as I2S0_MCLK */
    PORT_SetPinMux(BOARD_AC_SYS_MCLK_PORT, BOARD_AC_SYS_MCLK_PIN, kPORT_MuxAlt4);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
